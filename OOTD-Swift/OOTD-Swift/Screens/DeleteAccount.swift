                ...
                VStack {
                    ...
                    VStack {
                        ...
                        Button {
                            Task {
                                do {
                                    ...
                                    showingAlert = true
                                    alertMessage = "Account was deleted. Navigate to log in."
                        ...
                        .alert(isPresented: $showingAlert) {
                            Alert(title: Text("Account deletion status"), message: Text(alertMessage), dismissButton: .default(Text("OK")))
                        }
